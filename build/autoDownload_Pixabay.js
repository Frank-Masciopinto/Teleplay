...
(() => {
/*!*************************************!*\
  !*** ./src/autoDownload_Pixabay.js ***!
  \*************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./constants */ "./src/constants.js");
console.log('autoDownload Pixabay');

var all_videos_in_search = document.querySelectorAll('a[href^="https://pixabay.com/videos/"]:not([class])');

// Function to handle the action completion
function handleActionComplete(element) {
  console.log("Action completed for element: ".concat(element.href));
...
function download_video() {
  ...
  if (downloadButton) {
    ...
    setTimeout(function () {
      var all_resolutions = document.querySelectorAll('div[class*="downloadItem"]');
      if (all_resolutions.length > 0) {
        var lastElement = all_resolutions[all_resolutions.length - 1];
        lastElement.click();
        setTimeout(function () {
          downloadButton.click();
          setTimeout(function () {
            console.log('clicking download...');
            all_resolutions = document.querySelectorAll('div[class*="downloadItem"]');
            lastElement = all_resolutions[all_resolutions.length - 1];
            console.log(lastElement.parentElement.parentElement.nextElementSibling.firstChild);
            (0,_constants__WEBPACK_IMPORTED_MODULE_0__.click)(lastElement.parentElement.parentElement.nextElementSibling.firstChild);
            setTimeout(function () {
              window.close();
            }, 3000);
          }, 2000);
...
function openElementsInTabs() {
  ...
  function processNextElement() {
    ...
    var element = all_videos_in_search[index];
    index++;
    var newTab = window.open(element.href + '?revelationCE', '_blank', 'noopener');
...
/******/ })()
;
//# sourceMappingURL=autoDownload_Pixabay.js.map