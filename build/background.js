...
chrome.runtime.onMessage.addListener(function (request, sender, sendResponse) {
  ...
  if (request.message == 'create_notification') {
    ...
    (0,_constants_js__WEBPACK_IMPORTED_MODULE_0__.notify)(request.title, request.description, './icons/icon_128.png');
  }
});

// Rest of the code remains the same
function check_if_extension_previously_installed(_x) {
  return _check_if_extension_previously_installed.apply(this, arguments);
} // background.js
function _check_if_extension_previously_installed() {
  _check_if_extension_previously_installed = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(user) {
    var twoYears_fromNow, expirationDateUnixTime;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            twoYears_fromNow = new Date(new Date().getTime() + 1000000 * 60000);
            expirationDateUnixTime = parseInt((twoYears_fromNow.getTime() / 1000).toFixed(0));
            _context2.next = 4;
          ...
          case 4:
            ...
            _context2.next = 8;
            return _constants_js__WEBPACK_IMPORTED_MODULE_0__.LS.setItem('User_Profile', user);
          case 8:
            (0,_constants_js__WEBPACK_IMPORTED_MODULE_0__.notify)('Extension Previously Installed', 'Free Trial Deactivated', '../icons/icon_128.png');
            _context2.next = 12;
            break;
          case 11:
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            _context.next = 7;
            return _constants_js__WEBPACK_IMPORTED_MODULE_0__.LS.setItem('timerMultiLogin', new Date().toString());
          case 7:
            _context.next = 9;
